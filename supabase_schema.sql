...
-- Operational dashboard (see also docs/sql/voice_operational_realtime.sql for idempotent ALTERs on existing DBs)
...
-- =========================================================================
-- MVP platform extension (organizations, conversation_messages, analytics…)
-- Run in SQL Editor: docs/sql/mvp_platform_tables.sql
-- =========================================================================
